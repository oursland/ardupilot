...
const AP_Param::GroupInfo AP_ExternalAHRS::var_info[] = {
    ...
    // @Values: 0:None,1:VectorNav,2:MicroStrain5,5:InertialLabs,6:Trimble GSOF,7:MicroStrain7,8:SBG,12:InertialSense
    // @User: Standard
    ...
    // @Bitmask: 0:Vector Nav use uncompensated values for accel gyro and mag., 1:InertialSense use device as a raw IMU (disables on-device EKF; removes INS solution messages)
    // @User: Standard
