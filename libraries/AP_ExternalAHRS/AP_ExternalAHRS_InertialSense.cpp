    ...
    : AP_ExternalAHRS_backend(_frontend, _state)
{
    ...
    printf("Inertial Sense ExternalAHRS created: baudrate [%ld], port_num [%d]\n\n", baudrate, port_num);
...
void AP_ExternalAHRS_InertialSense::handleIns1Message(ins_1_t* ins)
{
    ...
    if ((AP_GPS_FixType)INS_STATUS_NAV_FIX_STATUS(ins->insStatus) >= AP_GPS_FixType::FIX_3D && !state.have_origin) {
